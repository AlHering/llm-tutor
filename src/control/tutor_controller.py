...
class TutorController(object):
    ...
    def load_documents(self, documents: List[Document], target_client: str = "base") -> None:
        """
        ...
        """
        self.knowledge_base.embed_documents(name=target_client, documents=documents)
    ...
    def load_files(self, file_paths: List[str], target_client: str = "base", splitting: Tuple[int] = None) -> None:
        ...
        """
        self.knowledge_base.load_files(file_paths, target_client, splitting)
